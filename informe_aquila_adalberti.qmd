...
![Resultados de favorabilidad para el águila imperial (A) 10 clases con pasos regulares de 0,1; (B) zonas desfavorables en color rojo (\< 0,2), zonas intermedias en color amarillo (0,2 -- 0,8) y zonas favorables en color verde (\> 0,8).](%60r%20file.path(paths$figure_path,%22fav_historical_model_c3_10.png%22)%60){#fig-fav}
...
![Partición de la varianza entre factores"](%60r%20file.path(paths$figure_path,%22variance_plot_color.png%22)%60){#fig-variance}
